...
if (process.env.NEXT_PUBLIC_API_PREFIX && process.env.NEXT_PUBLIC_PUBLIC_API_PREFIX) {
  ...
  if (isDevelopment) {
    apiPrefix = 'https://cloud.infrahive.dev/console/api'
    publicApiPrefix = 'https://dev.uinfrahive.app/api'
  }
  else {
    // const domainParts = globalThis.location?.host?.split('.');
    // in production env, the host is infrahive.app . In other env, the host is [dev].infrahive.app
