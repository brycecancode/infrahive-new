...
const FeatureItem: FC<IFeatureItemProps> = ({
  ...
  return (
    <div className='relative flex flex-col  p-3 rounded-xl border border-transparent bg-gray-50 mb-3'>
      <div className={cn(s.wrap, 'flex flex-row justify-between')}>
      ...
      {openingStatementConfig && <OpeningStatement {...openingStatementConfig} />}
    </div>
  )
}
