...
const SubscribeWrapper = styled('div')(({ theme }) => {
  const darkColorRTL
    = theme.palette.mode === 'dark'
      ? `linear-gradient(270deg, ${theme.palette.grey} 65%, ${theme.palette.grey} 65%)`
      : `linear-gradient(270deg, ${theme.palette.primary.light} 65%, #fff 65%)`
  const darkColor
    = theme.palette.mode === 'dark'
      ? `linear-gradient(90deg, ${theme.palette.grey} 65%, ${theme.palette.grey} 65%)`
      : `linear-gradient(90deg, ${theme.palette.primary.light} 65%, #fff 65%)`

  const darkColorRTL0
    = theme.palette.mode === 'dark'
      ? `linear-gradient(0deg, ${theme.palette.grey} 65%, ${theme.palette.grey} 65%)`
