...
It is recommended to verify the newly added language pack through local deployment of the latest code. For reference: https://docs.infrahive.ai/getting-started/install-self-hosted/local-source-code
Verification points:
