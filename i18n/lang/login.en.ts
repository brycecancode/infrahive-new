const translation = {
  ...
  welcome: 'Welcome to InfraHive, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting InfraHive Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on InfraHive',
  invalid: 'The link has expired',
  explore: 'Explore InfraHive',
