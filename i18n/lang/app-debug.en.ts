const translation = {
  ...
  automatic: {
    ...
    description: 'Describe your scenario, InfraHive will orchestrate an application for you.',
  ...
  formattingChangedText:
    'Moinfrahiveing the formatting will reset the debug area, are you sure?',
