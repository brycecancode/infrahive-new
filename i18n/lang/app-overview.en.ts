    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see InfraHive\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
        },
      },
      embedded: {
        entry: 'Embedded',
      ...
      customize: {
        ...
        way1: {
          name: 'Fork the client code, moinfrahive it and deploy to Vercel (recommended)',
          step1: 'Fork the client code and moinfrahive it',
          step1Tip: 'Click here to fork the source code into your GitHub account and moinfrahive the code',
          step1Operation: 'InfraHive-WebClient',
